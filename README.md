...
- docker build --build-arg --platform linux/amd64 -t weechien/flux:schnell-q4-0-gguf .
- docker push weechien/flux:schnell-q4-0-gguf
- docker build --build-arg HUGGINGFACE_ACCESS_TOKEN=<token> --platform linux/amd64 -t weechien/flux:dev-q8-0-gguf .
- docker push weechien/flux:dev-q8-0-gguf
